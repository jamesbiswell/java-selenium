...
public class HandlingFilesUploadsTest extends BaseTest {
    ...
    public void handlingFilesUploadsTest() {
        ...
        // WebElement fileField = driver.findElement(By.xpath("//input[@type='file' and @class='hidden']"));
        // fileField.sendKeys("/Users/luv2code/IdeaProjects/java-selenium-testng/src/main/resources/files/can_do.jpg");
