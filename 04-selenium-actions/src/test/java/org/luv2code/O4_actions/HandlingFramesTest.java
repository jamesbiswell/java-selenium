...
public class HandlingFramesTest extends BaseTest {
    ...
    public void handlingFramesTest() {
        ...
        String outerFrameDescription = driver.findElement(
                By.xpath("//p[text()='This iframe contains a nested inner iframe.']")).getText();
        ...
        // switch to default content
        String pageDescription = driver.findElement(
                By.xpath("//p[contains(text(),'Practice working with iframes')]")).getText();
